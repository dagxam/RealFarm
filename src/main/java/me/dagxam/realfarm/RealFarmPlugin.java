...
public final class RealFarmPlugin extends JavaPlugin {
    ...
    private FarmItems farmItems; private SeasonIntegration seasonIntegration;
    ...
    @Override public void onEnable() {
        ...
        getLogger().info("RealFarm включён. Участки, культуры, деревья и сезонная влажность активны.");
    }
